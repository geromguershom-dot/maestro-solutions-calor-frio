        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((s) => {
            ...
            return (
              <div
                key={s.title}
                className="group relative bg-white rounded-2xl border border-slate-200/70 hover:border-[var(--color-cyan)]/50 hover:shadow-xl hover:shadow-slate-200/60 transition-all duration-300 flex overflow-visible"
              >
                ...
                <div className="w-28 shrink-0 hidden sm:block relative">
                  <div className="absolute -top-3 -bottom-3 -right-3 left-0 rounded-2xl overflow-hidden shadow-lg ring-1 ring-black/5 group-hover:-right-4 group-hover:-top-4 group-hover:-bottom-4 transition-all duration-300">
